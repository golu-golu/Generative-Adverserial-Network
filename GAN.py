...
def generator(z, batch_size, z_dim):
    ...
    g4 = g4 + g_b4
    g4 = tf.nn.sigmoid_cross_entropy_with_logits(logits=g4,labels=tf.ones_like(g4))
...
d_trainer_fake = tf.train.GradientDescentOptimizer(0.0003).minimize(d_loss_fake, var_list=d_vars)
